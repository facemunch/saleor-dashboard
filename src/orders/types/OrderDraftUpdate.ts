...
export interface OrderDraftUpdate_draftOrderUpdate_order_fulfillments_lines_orderLine_variant_digitalContent {
...
export interface OrderDraftUpdate_draftOrderUpdate_order_fulfillments_lines_orderLine_variant {
  ...
  digitalContent: OrderDraftUpdate_draftOrderUpdate_order_fulfillments_lines_orderLine_variant_digitalContent | null;
}
...
export interface OrderDraftUpdate_draftOrderUpdate_order_lines_variant_digitalContent {
  __typename: "DigitalContent";
  id: string;
}
...
export interface OrderDraftUpdate_draftOrderUpdate_order_lines_variant {
  ...
  digitalContent: OrderDraftUpdate_draftOrderUpdate_order_lines_variant_digitalContent | null;
}
