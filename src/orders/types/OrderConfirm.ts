...
export interface OrderConfirm_orderConfirm_order_fulfillments_lines_orderLine_variant_digitalContent {
...
export interface OrderConfirm_orderConfirm_order_fulfillments_lines_orderLine_variant {
  ...
  digitalContent: OrderConfirm_orderConfirm_order_fulfillments_lines_orderLine_variant_digitalContent | null;
}
...
export interface OrderConfirm_orderConfirm_order_lines_variant_digitalContent {
  __typename: "DigitalContent";
  id: string;
}
...
export interface OrderConfirm_orderConfirm_order_lines_variant {
  ...
  digitalContent: OrderConfirm_orderConfirm_order_lines_variant_digitalContent | null;
}
