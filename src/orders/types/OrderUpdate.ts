...
export interface OrderUpdate_orderUpdate_order_fulfillments_lines_orderLine_variant_digitalContent {
...
export interface OrderUpdate_orderUpdate_order_fulfillments_lines_orderLine_variant {
  ...
  digitalContent: OrderUpdate_orderUpdate_order_fulfillments_lines_orderLine_variant_digitalContent | null;
}
...
export interface OrderUpdate_orderUpdate_order_lines_variant_digitalContent {
  __typename: "DigitalContent";
  id: string;
}
...
export interface OrderUpdate_orderUpdate_order_lines_variant {
  ...
  digitalContent: OrderUpdate_orderUpdate_order_lines_variant_digitalContent | null;
}
