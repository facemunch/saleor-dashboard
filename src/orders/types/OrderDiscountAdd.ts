...
export interface OrderDiscountAdd_orderDiscountAdd_order_fulfillments_lines_orderLine_variant_digitalContent {
...
export interface OrderDiscountAdd_orderDiscountAdd_order_fulfillments_lines_orderLine_variant {
  ...
  digitalContent: OrderDiscountAdd_orderDiscountAdd_order_fulfillments_lines_orderLine_variant_digitalContent | null;
}
...
export interface OrderDiscountAdd_orderDiscountAdd_order_lines_variant_digitalContent {
  __typename: "DigitalContent";
  id: string;
}
...
export interface OrderDiscountAdd_orderDiscountAdd_order_lines_variant {
  ...
  digitalContent: OrderDiscountAdd_orderDiscountAdd_order_lines_variant_digitalContent | null;
}
