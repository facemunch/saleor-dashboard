...
export interface OrderLineDelete_orderLineDelete_order_fulfillments_lines_orderLine_variant_digitalContent {
...
export interface OrderLineDelete_orderLineDelete_order_fulfillments_lines_orderLine_variant {
  ...
  digitalContent: OrderLineDelete_orderLineDelete_order_fulfillments_lines_orderLine_variant_digitalContent | null;
}
...
export interface OrderLineDelete_orderLineDelete_order_lines_variant_digitalContent {
  __typename: "DigitalContent";
  id: string;
}
...
export interface OrderLineDelete_orderLineDelete_order_lines_variant {
  ...
  digitalContent: OrderLineDelete_orderLineDelete_order_lines_variant_digitalContent | null;
}
