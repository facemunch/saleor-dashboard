...
export interface FulfillOrder_orderFulfill_order_fulfillments_lines_orderLine_variant_digitalContent {
...
export interface FulfillOrder_orderFulfill_order_fulfillments_lines_orderLine_variant {
  ...
  digitalContent: FulfillOrder_orderFulfill_order_fulfillments_lines_orderLine_variant_digitalContent | null;
}
...
export interface FulfillOrder_orderFulfill_order_lines_variant_digitalContent {
  __typename: "DigitalContent";
  id: string;
}
...
export interface FulfillOrder_orderFulfill_order_lines_variant {
  ...
  digitalContent: FulfillOrder_orderFulfill_order_lines_variant_digitalContent | null;
}
